...
//   If the $allowModification is false, the data is read-only
...
//    if a value was changed, show the new value, if not show, the default
...
//  Method so that $obj->value will work
...
//  only allow setting of a property if $allowModifications was set to true
    public function __set($name, $value)
    {
        if ($this->allowModifications) {
            ...
            throw new \Exception('Config wird nur gelesen');
        }
    }
...
//    With this method the date can't be modificated anymore
